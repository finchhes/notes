...
when you start from scratch it seems easy to just copy people that you really like, take their code and maybe switch it around a little. i did this and i heavily regret it, not only does it mean nothing is your own but it means you skip all of the foundational skills that every webdev should learn. i learned flex-box before i learned very basic html and css tags. 
